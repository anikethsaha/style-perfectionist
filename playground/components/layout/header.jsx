...
class Header extends Component {
    ...
    componentDidMount() {
        fetch(
            '//raw.githubusercontent.com/anikethsaha/style-perfectionist/master/playground/package.json'
        )
            .then((res) => res.json())
                ...
                >
                    <Pane flex={1} alignItems="center" display="flex">
                        <Heading size={600} style={{ letterSpacing: '.1rem' }}>
                            style-perfectionist PlayGround
                        </Heading>
                        <Badge color="yellow" isSolid margin={10} marginY={15}>
                            <code>
                                v{this.context.playgroundInfo.version || ''}
                            </code>
                        </Badge>
                    </Pane>
                    ...
                    <Pane>
                        <Pane>
                            <Pane
                                ...
                                display="flex"
                            >
                                <StyledLink href="https://github.com/anikethsaha/style-perfectionist">
                                    <FaGithub />
                                </StyledLink>
